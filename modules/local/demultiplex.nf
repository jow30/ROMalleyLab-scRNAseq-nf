process DEMULTIPLEX {
    ...
    label 'scrnaseq'
    publishDir "${params.out}/demultiplex", mode: 'copy', saveAs: { fn -> def base = fn.tokenize('/').last(); (base.startsWith('summary_') || base.startsWith('seur_diem_barcodes_') || base.startsWith('seur_objs_')) ? null : fn }
