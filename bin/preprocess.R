...
# for testing
# options(
#   inputDir = "/project/gzy8899/qiaoshan/scRNAseq/experiments/At_Cr_5d_seedling_2025/Athaliana_5d_seedling_XC/outs",
#   sample = "Athaliana_5d_seedling_XC",
#   species = "Arabidopsis thaliana",
#   outDir = "/project/gzy8899/qiaoshan/scRNAseq/experiments/At_Cr_5d_seedling_2025/seurat",
#   velocyto_txt = "/project/gzy8899/qiaoshan/scRNAseq/experiments/At_Cr_5d_seedling_2025/seurat/Athaliana_5d_seedling_XC.txt",
...
if (is.null(opt[["velocyto_txt"]])) {
  cat("###Warning### velocyto_txt is not provided. The process will stop right after diem debris filtering.\n\n")
}
...
if (is.null(opt[["velocyto_txt"]])) {
  ...
  message("###WARNING### Program stops after DIEM debris filtering since velocyto output is NOT available. Please rerun the preprocess program once velocyto_txt is available.")
  quit(status = 0)
} else {
  # seur_diem <- readRDS(paste0("seur_diem_", opt$sample, ".rds"))
